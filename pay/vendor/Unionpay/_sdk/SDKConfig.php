...
// certs目录
// const CERTS_PATH = dirname(__DIR__) . DS . 'assets' . DS . 'certs' . DS;

// 签名证书密码
const SDK_SIGN_CERT_PWD = SDK_SIGN_CERT_PWD;
// 签名证书路径
const SDK_SIGN_CERT_PATH = '/home/wwwroot/xtaoyuan/Framework/Extend/Vendor/Unionpay/assets/certs/acp_prod_sign.pfx';
// 密码加密证书（这条一般用不到的请随便配）
const SDK_ENCRYPT_CERT_PATH = '/home/wwwroot/xtaoyuan/Framework/Extend/Vendor/Unionpay/assets/certs/acp_prod_enc.cer';

// 验签证书路径（请配到文件夹，不要配到具体文件）
const SDK_VERIFY_CERT_DIR = '/home/wwwroot/xtaoyuan/Framework/Extend/Vendor/Unionpay/assets/certs/';
...
// 前台通知地址 (商户自行配置通知地址)
const SDK_FRONT_NOTIFY_URL = SDK_FRONT_NOTIFY_URL;

// 后台通知地址 (商户自行配置通知地址，需配置外网能访问的地址)
const SDK_BACK_NOTIFY_URL = SDK_BACK_NOTIFY_URL;
